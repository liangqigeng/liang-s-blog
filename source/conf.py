...
project = u'LIANG\'s BLOG' 
copyright = u'2019, 梁同学'
...
latex_documents = [
  ('index', 'python3-cookbook.tex', u'《编程之光》',
   u'梁同学', 'howto'),
]
...
texinfo_documents = [
  ('index', 'Python-Time', u'《编程之光》',
   u'梁同学', 'Python-Time', '《编程之光》',
   'Miscellaneous'),
]
